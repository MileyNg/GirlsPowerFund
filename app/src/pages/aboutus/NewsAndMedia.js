...
function NewsAndMedia() {
  ...
  const data = {
    ...
    text: t("ourteam4"),
    href: "https://www.columbiaspectator.com/news/2022/09/19/a-dozen-obama-scholars-join-campus-community/",
  ...
  const data2 = {
    ...
    href: "https://boostimpact.org/innovations/girls-power-fund/",
    buttonText: t("readmore"),
    image: undp_pic,
    alt: "UNDP picture",
    borderImage: "",
